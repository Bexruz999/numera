                    ...
                    <div class="consult__cards swiper-wrapper">
                        <div class="consult__card swiper-slide">
                            ...
                            <div class="consult__card_text">
                                Берём на себя учёт всех операций — от
                                первички до отчётности. Любая система
                                налогообложения, порядок в цифрах
                                гарантирован.
                            </div>
                        </div>
                        <div class="consult__card swiper-slide">
                            ...
                            <div class="consult__card_text">
                                Готовим и сдаём налоговую,
                                статистическую и внебюджетную
                                отчётность. Без просрочек, штрафов и
                                головной боли.
                            </div>
                        </div>
                        <div class="consult__card swiper-slide">
                            ...
                            <div class="consult__card_text">
                                Помогаем с расчётами, отчётами,
                                переходом на другую систему. Даем
                                чёткие, практичные ответы — без
                        ...
                        <div class="consult__card swiper-slide">
                            ...
                            <div class="consult__card_text">
                                Полностью берём на себя бухгалтерию и
                                сопровождение бизнеса. Вы занимаетесь
                                ростом — мы следим за цифрами.
                            </div>
                        </div>
                    </div>
                </div>
