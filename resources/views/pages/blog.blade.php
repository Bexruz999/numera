        ...
        <div class="form__container">
            <div class="form__content">
                ...
                <div class="form__content_cta">
                    ...
                    />
                    <img
                        src="../img/png/form-bg01.png"
                        alt="#"
                        class="form__content_bg-bg01"
                    />
                    <img
                        src="../img/png/form-bg01.png"
                        alt="#"
                        class="form__content_bg-bg02"
                    />
                </div>
            </div>
            <div class="form__form form--form" id="form01">
                ...
                <div class="form__form-text text">
                    Мы всегда готовы проконсультировать вас по услугам,
                    тарифам и сотрудничеству. Напишите нам, позвоните
